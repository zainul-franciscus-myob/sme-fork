...
const createContactModalDispatcher = store => ({
  ...
  loadContactModal: response => store.dispatch({ intent: LOAD_CONTACT_MODAL, ...response }),

  setContactModalDetails: ({ key, value }) => store.dispatch({
    intent: SET_CONTACT_MODAL_DETAILS, key, value,
  }),

  setShowContactModalBillingAddress: showBillingAddress => store.dispatch({
    intent: SET_SHOW_CONTACT_MODAL_BILLING_ADDRESS, showBillingAddress,
  }),

  setContactModalBillingAddress: ({ key, value }) => store.dispatch({
    intent: SET_CONTACT_MODAL_BILLING_ADDRESS, key, value,
  }),

  setShowContactModalShippingAddress: showShippingAddress => store.dispatch({
    intent: SET_SHOW_CONTACT_MODAL_SHIPPING_ADDRESS, showShippingAddress,
  }),

  setContactModalShippingAddress: ({ key, value }) => store.dispatch({
    intent: SET_CONTACT_MODAL_SHIPPING_ADDRESS, key, value,
  }),
