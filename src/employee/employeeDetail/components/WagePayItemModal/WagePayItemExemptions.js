...
import { getExemptionAllocations } from '../../selectors/WagePayItemModalSelectors';
import handleComboboxChange from '../../../../components/handlers/handleComboboxChange';
import styles from './WagePayItemExemptions.module.css';
...
export default connect(mapToStateProps)(WagePayItemExemptions);
