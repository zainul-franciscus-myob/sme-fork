...
export const getIsExpensePayItemModalCreating = state => getExpensePayItemModal(state).id === 'new';
...
export const getIsActionDisabled = state => getExpensePayItemModal(state).isSubmitting;

export const getName = state => getExpensePayItemModal(state).name;

export const getLinkedExpenseAccountOptions = state => getExpensePayItemModal(state)
  .linkedExpenseAccountOptions;

export const getLinkedPayablesAccountOptions = state => getExpensePayItemModal(state)
  .linkedPayablesAccountOptions;

export const getLinkedExpenseAccountId = state => getExpensePayItemModal(state)
  .linkedExpenseAccountId;

export const getLinkedPayablesAccountId = state => getExpensePayItemModal(state)
  .linkedPayablesAccountId;

export const getIsPrintOnPaySlip = state => getExpensePayItemModal(state).isPrintOnPaySlip;
...
export const getCalculationBasisPayItemId = state => getExpensePayItemModal(state)
  .calculationBasisPayItemId;

export const getCalculationBasisAmount = state => getExpensePayItemModal(state)
  .calculationBasisAmount;

export const getCalculationBasisPeriod = state => getExpensePayItemModal(state)
  .calculationBasisPeriod;

export const getCalculationBasisPayItemOptions = state => getExpensePayItemModal(state)
  .calculationBasisPayItemOptions;

export const getPeriodOptions = state => getExpensePayItemModal(state).periodOptions;

export const getLimit = state => getExpensePayItemModal(state).limit;

export const getLimitPercentage = state => getExpensePayItemModal(state).limitPercentage;

export const getLimitPayItemId = state => getExpensePayItemModal(state).limitPayItemId;

export const getLimitAmount = state => getExpensePayItemModal(state).limitAmount;

export const getLimitPeriod = state => getExpensePayItemModal(state).limitPeriod;

export const getLimitPayItemOptions = state => getExpensePayItemModal(state).limitPayItemOptions;

export const getAllocatedEmployees = state => getExpensePayItemModal(state).allocatedEmployees;

export const getEmployeeOptions = state => getExpensePayItemModal(state).employeeOptions;
...
export const getUnallocatedEmployeeOptions = createSelector(
  ...
  (employeeOptions, allocatedEmployees) => employeeOptions.reduce((accumulator, employee) => {
    const found = allocatedEmployees
      .find(allocatedEmployee => allocatedEmployee.id === employee.id);
...
export const getExemptionPayItemOptions = state => getExpensePayItemModal(state)
...
export const getUnaddedExemptionPayItemOptions = createSelector(
  ...
  (exemptionPayItemOptions, exemptionPayItems) => exemptionPayItemOptions
    .reduce((accumulator, exemption) => {
...
export const getIsSubmitting = state => getExpensePayItemModal(state).isSubmitting;

export const getIsCreating = state => getExpensePayItemModal(state).expensePayItemId === 'new';

const getPayItemMappedType = (
  payItems,
  payItemId,
