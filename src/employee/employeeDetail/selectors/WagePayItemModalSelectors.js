...
export const getIsWagePayItemModalCreating = state => getWagePayItemModal(state).id === 'new';
...
export const getIsActionDisabled = state => getWagePayItemModal(state).isSubmitting;

export const getWage = state => getWagePayItemModal(state).wage;

export const getAtoReportCategoryList = state => getWagePayItemModal(state).atoReportCategoryList;
...
export const getDefaultAccountId = state => getWagePayItemModal(state).defaultAccountId;

export const getOverrideAccount = state => getWagePayItemModal(state).overrideAccount;
...
export const getSaveWagePayItemModalPayload = (state) => {
  const {
    wage: {
      selectedEmployees, selectedExemptions, accountId, isSystem, ...rest
    },
    overrideAccount,
