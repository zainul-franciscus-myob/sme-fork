...
export const getSellingUnitOfMeasure = state => state.item.sellingDetails.unitOfMeasure;

export const getSellingAccountId = state => state.item.sellingDetails.accountId;

export const getSellingTaxCodeId = state => state.item.sellingDetails.taxCodeId;

export const getBuyingPrice = state => state.item.buyingDetails.price;

export const getBuyingUnitOfMeasure = state => state.item.buyingDetails.unitOfMeasure;
