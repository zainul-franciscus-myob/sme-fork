export const LOAD_BANKING_RULE_LIST = Symbol('Load the banking rule list');
export const SORT_AND_FILTER_BANKING_RULE_LIST = Symbol('Sort and filter the banking rule list');
