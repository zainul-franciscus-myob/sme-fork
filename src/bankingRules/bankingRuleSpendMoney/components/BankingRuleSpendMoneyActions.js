...
import { getIsCreating } from '../bankingRuleSpendMoneySelectors';

const BankingRuleSpendMoneyActions = ({
  onSaveButtonClick,
  onCancelButtonClick,
  onDeleteButtonClick,
  isCreating,
...
export default connect(mapStateToProps)(BankingRuleSpendMoneyActions);
