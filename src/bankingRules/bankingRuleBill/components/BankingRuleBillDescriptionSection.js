...
import { getDescriptionSection } from '../bankingRuleBillSelectors';
...
const BankingRuleBillDescriptionSection = ({
  applyToAllAccounts,
  accountId,
  bankAccounts,
  containsWords,
...
export default connect(mapStateToProps)(BankingRuleBillDescriptionSection);
