...
describe('getDateRangeByPeriodAndRegion', () => {
    ...
    describe('Last three months', () => {
      describe('dateFrom', () => {
        it('should be Jan 28 if current date is April 28', () => {
          ...
          const lastThreeMonths = getDateRangeByPeriodAndRegion(
            '',
            date,
            period
          );
  ...
  describe('au', () => {
    const getPeriodOptionByIdAu = (date) => (period) =>
      getDateRangeByPeriodAndRegion('au', date, period);
    describe('This financial quarter period', () => {
      describe('dateFrom', () => {
        it('should be start of Jan if between Jan and Mar', () => {
          const getPeriodOptionsById = getPeriodOptionByIdAu(
            new Date('2019-03-04')
          );

          const thisFinancialQuarter = getPeriodOptionsById(
    ...
    describe('This financial year period', () => {
      describe('dateFrom', () => {
        it('should be Jul 1 of current year if after Jun', () => {
          ...
          const thisFinancialYear = getPeriodOptionsById(
    ...
    describe('Last financial quarter period', () => {
      describe('dateFrom', () => {
        it('should be start of Oct if between Jan and Mar', () => {
          ...
          const lastFinancialQuarter = getPeriodOptionsById(
    ...
    describe('Last financial year period', () => {
      describe('dateFrom', () => {
        it('should be Jul 1 of previous year if before July', () => {
          ...
          const lastFinancialYear = getPeriodOptionsById(
  ...
  describe('nz', () => {
    const getPeriodOptionByIdNz = (date) => (period) =>
      getDateRangeByPeriodAndRegion('nz', date, period);
    describe('This financial quarter period', () => {
      describe('dateFrom', () => {
        it('should be start of Jan if between Jan and Mar', () => {
          const getPeriodOptionsById = getPeriodOptionByIdNz(
            new Date('2019-03-04')
          );
