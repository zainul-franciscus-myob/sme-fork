...
export const getSuperannuationSortOrder = state => state.superannuation.sortOrder;
...
export const getIsDeductionsTableEmpty = ({ deductions }) => (deductions.entries.length === 0);
...
export const getIsExpensesTableEmpty = ({ expenses }) => (expenses.entries.length === 0);
