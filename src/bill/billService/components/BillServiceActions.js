...
import { getIsActionsDisabled } from '../billServiceSelectors';

const BillServiceActions = ({
  isCreating,
  isActionsDisabled,
  onSaveButtonClick,
  onCancelButtonClick,
...
export default connect(mapStateToProps)(BillServiceActions);
