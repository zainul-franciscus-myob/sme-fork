...
describe('formatNumberWithRoundPrecision', () => {
  it.each([
    ...
    ['should round number up to max decimal scale when the digits after max decimal place is larger than 4', 40.005, 1, 2, '40.01'],
    ['should round number down to max decimal scale when the digits after max decimal place is less than 5', 40.014, 1, 2, '40.01'],
