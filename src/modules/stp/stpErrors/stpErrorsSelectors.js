...
export const getPayItemPageUrl = (state, itemType, id) => {
  ...
  return itemType === 'tax'
    ? `${baseUrl}/payItem?tab=tax`
    : `${baseUrl}/payItem/${itemType}/${id}`;
};
...
export const getIsBusinessDetailsModalOpen = (state) =>
  state.businessDetailsModalIsOpen;
export const getBusinessDetailsModalIsLoading = (state) =>
  state.businessDetailsModalIsLoading;
export const getBusinessDetailModalAlertMessage = (state) =>
  state.businessDetailModalAlertMessage;
...
export const getStreetAddress1 = (state) =>
  state.businessDetails.streetAddress1;
export const getStreetAddress2 = (state) =>
  state.businessDetails.streetAddress2;
