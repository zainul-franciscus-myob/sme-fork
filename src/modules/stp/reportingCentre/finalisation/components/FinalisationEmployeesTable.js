...
const tableConfig = {
  ...
  grossPaymentYtd: {
    columnName: 'Gross YTD ($)',
    width: 'flex-1',
    valign: 'middle',
    align: 'right',
  },
  paygWithholdingYtd: {
    columnName: 'PAYG withholding YTD ($)',
    width: 'flex-1',
    valign: 'middle',
    align: 'right',
  },
  ...
  section57a: {
    columnName: 'Section 57A ($)',
    width: 'flex-1',
    align: 'right',
  },
  isFinalised: {
    columnName: 'Final indicator',
    width: 'flex-1',
    valign: 'middle',
    align: 'left',
  },
  ...
  const header = (
    <Table.Header>
      ...
      <Table.HeaderItem {...tableConfig.employeeFirstName}>
        <HeaderSort
          title={tableConfig.employeeFirstName.columnName}
          sortName="FirstName"
      ...
      <Table.HeaderItem {...tableConfig.employeeLastName}>
        <HeaderSort
          title={tableConfig.employeeLastName.columnName}
          sortName="LastName"
          activeSort={activeSort}
          onSort={onSort}
        />
      ...
      <Table.HeaderItem {...tableConfig.moreOptions}></Table.HeaderItem>
    </Table.Header>
  );
          ...
          <Table.RowItem {...tableConfig.rfba}>
            {employee.isFinalised ? (
              ...
              <AmountInput
                ...
                onChange={handleAmountInputChange(({ key, value }) =>
                  onEmployeeChange({
                    key,
                    value,
                    rowId: employee.id,
