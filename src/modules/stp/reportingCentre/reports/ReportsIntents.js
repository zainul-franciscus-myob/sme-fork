...
export const LOAD_PAY_EVENTS = Symbol('Load STP Pay Events');
export const FILTER_PAY_EVENTS = Symbol('Filter STP Pay Events');
export const SET_PAY_EVENTS = Symbol('Set the STP Pay Events');
export const SET_FILTERED_PAY_EVENTS = Symbol(
  'Set the filtered STP Pay Events'
);
...
export const SET_DETAILS_LOADING_STATE = Symbol(
  'Set the loading state in the details'
);
...
export const LOAD_EMPLOYEE_YTD_REPORT = Symbol(
  'Load employee Pay Event report'
);
