...
const PayRunMapping = {
  ...
  [DELETE_PAY_RUN_DRAFT]: {
    method: 'DELETE',
    getPath: ({ businessId }) => `/${businessId}/payrunOld/delete_pay_run_draft`,
  },
  [LOAD_EMPLOYEE_PAYS]: {
    method: 'GET',
  ...
  [VALIDATE_PAY_PERIOD_EMPLOYEE_LIMIT]: {
    method: 'POST',
    getPath: ({ businessId }) => `/${businessId}/payrunOld/validate_pay_period_employee_limit`,
  },
  ...
  [SAVE_DRAFT]: {
    method: 'POST',
    getPath: ({ businessId }) => `/${businessId}/payrunOld/save_pay_run_draft`,
  },
  [LOAD_STP_REGISTRATION_STATUS]: {
    method: 'GET',
    getPath: ({ businessId }) => `/${businessId}/payrunOld/load_stp_registration_status`,
  },
};
