import { Card, Field, FieldGroup, Select } from '@myob/myob-widgets';
...
const SalesSettingsPaymentsDetails = ({
  ...
  const paymentTerm = (
    <FieldGroup label="Default payment terms">
      <p>
        Choose the default payment terms for your invoices. You can always
        change these terms when creating an invoice.
      </p>
