...
export const getInvoiceEmailBody = state => state.emailSettings.invoiceEmailBody;
export const getInvoiceEmailSubject = state => state.emailSettings.invoiceEmailSubject;
export const getIsInvoiceNumberIncluded = state => state.emailSettings.isInvoiceNumberIncluded;
