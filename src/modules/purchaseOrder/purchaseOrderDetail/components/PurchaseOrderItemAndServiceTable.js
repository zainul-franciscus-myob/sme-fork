...
import PurchaseOrderItemAndServiceTableRow from './PurchaseOrderItemAndServiceTableRow';
...
const renderRow = ({
  ...
  <PurchaseOrderItemAndServiceTableRow
    index={index}
    key={index}
    onChange={onChange}
...
const PurchaseOrderItemAndServiceTable = ({
  listeners: {
    onAddRow,
    onRowChange,
    onRowInputBlur,
...
export default connect(mapStateToProps)(PurchaseOrderItemAndServiceTable);
