...
const getShouldDisplayBadge = ({ isActive }, showHiddenColumns) =>
  showHiddenColumns && !isActive;
...
export const getFormattedTableEntries = createSelector(
  ...
  (entries, businessId, region, showHiddenColumns) =>
    entries.map((entry) => ({
      ...entry,
...
export const getTypeOptions = createSelector(getTypeFilters, (typeFilters) =>
