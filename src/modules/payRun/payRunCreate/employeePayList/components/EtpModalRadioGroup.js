      ...
      ({
        [EtpCodeCategory.LIFE]: [
          {
            code: EtpCode.R,
            label:
              'Payment due to early retirement screen, genuine redundancy, invalidity, or compensationf or personal injury, unfair dismissal, harassment, discrimination',
          },
          {
            code: EtpCode.O,
            label:
        ...
        [EtpCodeCategory.MULTIPLE]: [
          {
            code: EtpCode.S,
            label:
              "Use when you've made a code R payment to the employee in a previous income year for the same termination",
          },
          {
            code: EtpCode.P,
            label:
              "Use when you've made a code O payment to the employee in a previous income year for the same termination",
          },
        ].map(({ code, label }) => (
          <EtpModalRadioButton
            key={code}
        ...
        [EtpCodeCategory.DEATH]: [
          ...
          },
          {
            code: EtpCode.B,
            label:
              'Payment to non-dependant of deceased and you made a termination payment to the non-dependent in a previous income year for the same termination',
          },
          {
            code: EtpCode.N,
