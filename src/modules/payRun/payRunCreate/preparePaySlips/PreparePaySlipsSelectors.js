...
export const getEmailTabEmployees = state => state.preparePaySlips.emailPaySlipEmployees;
export const getPrintTabEmployees = state => state.preparePaySlips.printPaySlipEmployees;
export const getEmailSettings = state => state.preparePaySlips.emailSettings;
export const getSelectedEmployeesToEmail = state => getEmailTabEmployees(state)
