export const getResponsiveConfig = (tableConfig) => [
  {
    ...
    config: [
      ...
      {
        columnName: tableConfig.displayAccountName.columnName,
        styles: { width: 'flex-1' },
      },
      {
        columnName: tableConfig.sourceJournal.columnName,
        styles: { width: '12.4rem' },
      },
      {
        columnName: tableConfig.displayDebit.columnName,
        styles: { width: '12.4rem' },
      },
      {
        columnName: tableConfig.displayCredit.columnName,
        styles: { width: '12.4rem' },
      },
    ],
  },
