export const LOAD_CUSTOMER_RETURN_LIST = Symbol('Load customer return list');
...
export const SORT_AND_FILTER_CUSTOMER_RETURN_LIST = Symbol('Sort and filter customer return list');
