...
describe('supplierPaymentDetailReducer', () => {
  describe('LOAD_PURCHASE_LIST', () => {
    const action = {
      intent: LOAD_PURCHASE_LIST,
      entries: [
        {
          id: '1',
          purchaseNumber: '0000023',
          status: 'Open',
          date: '27/03/2019',
          purchaseAmount: '250.05',
          discountAmount: '',
          paidAmount: '',
        },
        {
    ...
    it('loads entries', () => {
      ...
      const actual = supplierPaymentDetailReducer(state, action);
  ...
  describe('LOAD_NEW_SUPPLIER_PAYMENT', () => {
  ...
  describe('LOAD_SUPPLIER_PURCHASE_LIST', () => {
  ...
  describe('LOAD_SUPPLIER_PAYMENT', () => {
    [
      {
        fromName: 'someone',
