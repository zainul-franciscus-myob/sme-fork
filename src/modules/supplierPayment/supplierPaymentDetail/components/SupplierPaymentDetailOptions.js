...
import { getSupplierPaymentOptions } from '../SupplierPaymentDetailSelectors';
...
import styles from './SupplierPaymentDetailOptions.module.css';
...
const mapStateToProps = (state) => ({
  ...getSupplierPaymentOptions(state),
});

export default connect(mapStateToProps)(SupplierPaymentOptions);
