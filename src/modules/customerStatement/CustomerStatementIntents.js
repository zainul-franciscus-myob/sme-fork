...
export const SET_ARE_ACTIONS_DISABLED = Symbol('Set are actions disabled');
...
export const SET_MODAL_ALERT_MESSAGE = Symbol('Set modal alert message');

export const LOAD_CUSTOMER_STATEMENTS = Symbol('Load customer statements');
export const SORT_AND_FILTER_CUSTOMER_STATEMENTS = Symbol(
  'Filter customer statements'
);
...
export const UPDATE_TEMPLATE_ADDITIONAL_OPTIONS = Symbol(
  'Update template additional options'
);
...
export const TOGGLE_ALL_CUSTOMER_STATEMENTS = Symbol(
  'Toggle all customer statements'
);
export const UNSELECT_ALL_CUSTOMER_STATEMENTS = Symbol(
  'Unselect all customer statements'
);
