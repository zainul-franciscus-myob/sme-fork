...
import { getConditionLabel, getConditionsSection } from '../bankingRuleDetailSelectors';
import FieldTypes from '../FieldTypes';
import handleInputChange from '../../../../components/handlers/handleInputChange';
import handleSelectChange from '../../../../components/handlers/handleSelectChange';
import styles from './BankingRuleDetailConditionsSection.module.css';
...
const ConditionsSection = ({
  ...
  <FieldGroup label={conditionLabel}>
    {
...
const mapStateToProps = state => ({
  conditionLabel: getConditionLabel(state),
  conditions: getConditionsSection(state),
});
