...
export const LOAD_NEW_BANKING_RULE = Symbol('Load new bank rule');
export const LOAD_BANKING_RULE = Symbol('Load bank rule');
export const CREATE_BANKING_RULE = Symbol('Create bank rule');
export const UPDATE_BANKING_RULE = Symbol('Update bank rule');
export const DELETE_BANKING_RULE = Symbol('Delete bank rule');
