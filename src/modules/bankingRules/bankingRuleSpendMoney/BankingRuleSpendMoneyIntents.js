...
export const LOAD_NEW_BANKING_RULE_SPEND_MONEY = Symbol('Load new spend money bank rule');
export const LOAD_BANKING_RULE_SPEND_MONEY = Symbol('Load spend money bank rule');
export const CREATE_BANKING_RULE_SPEND_MONEY = Symbol('Create spend money bank rule');
export const UPDATE_BANKING_RULE_SPEND_MONEY = Symbol('Update spend money bank rule');
export const DELETE_BANKING_RULE_SPEND_MONEY = Symbol('Delete spend money bank rule');
