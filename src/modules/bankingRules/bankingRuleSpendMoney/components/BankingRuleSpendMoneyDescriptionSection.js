...
import { getDescriptionSection } from '../bankingRuleSpendMoneySelectors';
...
const BankingRuleSpendMoneyDescriptionSection = ({
  applyToAllAccounts,
  accountId,
  bankAccounts,
  containsWords,
...
export default connect(mapStateToProps)(BankingRuleSpendMoneyDescriptionSection);
