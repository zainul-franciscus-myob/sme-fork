...
describe('accountDetailReducer', () => {
  ...
  describe('UPDATE_ACCOUNT_NUMBER', () => {
    ...
    describe('when is flex account numbers', () => {
      ...
      it('updates if is is less than 10 chars', () => {
        const state = {
          detail: { accountNumber: 'abcd' },
          readonly: { accountNumberPrefix: 'a' },
          isFlexAccount: true,
