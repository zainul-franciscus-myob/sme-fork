...
export const getFilteredSuperPayItemOptions = createSelector(
  ...
  (payItemOptions, allocatedPayItems) =>
    payItemOptions.filter((payItemOption) => {
...
export const getCreateSuperChoiceFormLink = () =>
  'https://www.ato.gov.au/assets/0/104/2244/2335/35c234b5-6918-4dd0-a3db-95edfd76adc0.pdf';
