...
export const getIsPaySuperEnabled = (state) =>
  state.superFundModal.isPaySuperEnabled;
export const getSignUpForPaySuperUrl = (state) =>
  state.superFundModal.registerPaySuperUrl;
...
export const getShowContactDetails = (state) =>
  state.superFundModal.showContactDetails;
...
export const getSaveSuperFundPayload = createStructuredSelector({
  ...
  electronicServiceAddress: (state) =>
    state.superFundModal.superFund.electronicServiceAddress,
  employerMembershipNumber: (state) =>
    state.superFundModal.superFund.employerMembershipNumber,
  fundType: getFundType,
  superProductAbn: (state) => state.superFundModal.superFund.superProductAbn,
  superFundIdentifier: (state) =>
    state.superFundModal.superFund.superFundIdentifier,
