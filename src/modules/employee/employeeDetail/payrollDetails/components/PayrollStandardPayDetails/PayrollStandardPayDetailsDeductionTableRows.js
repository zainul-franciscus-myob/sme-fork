...
const PayrollStandardPayDetailsDeductionTableRows = props => (
  <PayrollStandardPayDetailsTableRows name="deductions" title="Deductions" {...props} />
);

const mapStateToProps = state => getDeductionTableRows(state);

export default connect(mapStateToProps)(PayrollStandardPayDetailsDeductionTableRows);
