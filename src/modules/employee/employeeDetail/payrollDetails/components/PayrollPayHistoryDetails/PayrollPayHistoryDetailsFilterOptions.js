...
const fieldGroupLabel = (
  <div>
    ...
    <Tooltip triggerContent={<Icons.Info />} placement="right">
      If you started processing pays half way through the payroll year, enter
      the employee&#39;s pay history for the periods prior to the first recorded
      pay.
    </Tooltip>
  </div>
);
