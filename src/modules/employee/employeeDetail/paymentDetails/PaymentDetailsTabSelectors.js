...
export const getSplitNetPayBetweenOptions = (state) =>
  state.splitNetPayBetweenOptions;
export const getElectronicPaymentDetails = (state) =>
  state.paymentDetails.paymentMethod === 'Electronic';
