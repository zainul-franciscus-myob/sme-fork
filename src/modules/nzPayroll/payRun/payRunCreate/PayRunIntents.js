...
export const UPDATE_EMPLOYEE_DAYS_PAID = Symbol('Updates a given employees days paid amount');
...
export const SET_TOTAL_TAKE_HOME_PAY = Symbol('Sets amount for total take home pay');
