...
describe('StartPayRunView', () => {
  ...
  describe('when new pay frequency is selected', () => {
    ...
    it('should select pay frequency', () => {
      ...
      expect(
        wrapper
          .find({ testid: 'testPaymentFrequency' })
          .find(Select)
          .prop('value')
      ).toEqual(value);
    });
    ...
    it('should set all pay period dates to empty', () => {
      ...
      expect(
        wrapper
          .find({ testid: 'testPayPeriodStart' })
          .find(DatePicker)
          .prop('value')
      ).toEqual(emptyPeriodDate);
      expect(
        wrapper
          .find({ testid: 'testPayPeriodEnd' })
          .find(DatePicker)
          .prop('value')
      ).toEqual(emptyPeriodDate);
      expect(
        wrapper
          .find({ testid: 'testPayPeriodPaymentDate' })
          .find(DatePicker)
          .prop('value')
      ).toEqual(emptyPeriodDate);
    });
