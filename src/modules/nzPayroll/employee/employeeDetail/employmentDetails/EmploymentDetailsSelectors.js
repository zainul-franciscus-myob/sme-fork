...
const getEmploymentDetails = state => state.payrollDetails?.employmentDetails || {};
...
export const getGender = createSelector(getEmploymentDetails, ({ gender }) => gender);

export const getStartDate = createSelector(getEmploymentDetails, ({ startDate }) => startDate);
