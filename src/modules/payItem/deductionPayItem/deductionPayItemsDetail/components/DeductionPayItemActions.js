...
import { getIsCreating, getIsSubmitting } from '../DeductionPayItemSelectors';

const DeductionPayItemActions = ({
  isCreating,
  isSubmitting,
  onSaveButtonClick,
  onCancelButtonClick,
...
export default connect(mapStateToProps)(DeductionPayItemActions);
