...
export const getLinkedExpenseAccountOptions = state => state.linkedExpenseAccountOptions;
export const getLinkedPayablesAccountOptions = state => state.linkedPayablesAccountOptions;
export const getLinkedExpenseAccountId = state => state.linkedExpenseAccountId;
export const getLinkedPayablesAccountId = state => state.linkedPayablesAccountId;
...
export const getCalculationBasisPercentage = state => state.calculationBasisPercentage;
export const getCalculationBasisPayItemId = state => state.calculationBasisPayItemId;
export const getCalculationBasisAmount = state => state.calculationBasisAmount;
export const getCalculationBasisPeriod = state => state.calculationBasisPeriod;
export const getCalculationBasisPayItemOptions = state => state.calculationBasisPayItemOptions;
