...
export const UPDATE_APPLIED_FILTER_OPTIONS = Symbol(
  'Update applied filter options'
);
export const LOAD_ACCOUNTS_AND_SUPER_PAYMENTS = Symbol(
  'Load accounts and super payments'
);
export const UPDATE_SELECTED_ACCOUNT_ID = Symbol('Update selected account id');
export const SORT_AND_FILTER_SUPER_PAYMENTS = Symbol(
  'Sort and filter super payments'
);
...
export const UPDATE_AUTHORISATION_INFORMATION = Symbol(
  'Update authorisation information'
);
