...
const BankFeedsOnline = ({
  ...
  const copy = (refNumber) => {
    onCopy(refNumber);
    setCopyAlertText('Copied! You can use this reference number to activate bank feeds with your bank.');
  };
  ...
  return (
    <>
      ...
      Finish your bank feed application by logging in to your
      online banking system and activating bank feeds with MYOB.

      <div className={styles.alert}>
        <Alert inline type="info">Copy this number before continuing to your online banking.</Alert>
      </div>
      ...
      Once you&apos;ve activated bank feed in your online banking page, your bank
      will review your application.  They&apos;ll send us a confirmation and
