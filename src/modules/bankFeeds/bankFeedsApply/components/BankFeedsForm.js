...
const BankFeedsForm = ({
  ...
  const copy = (email) => {
    onCopy(email);
    setCopyAlertText(
      'Copied! You can send your signed form to this email address.'
    );
  };
  ...
  return (
    <>
      ...
      Check your email {userEmail && <b>{userEmail}</b>} or click the button
      below to download and print your form. Sign the printed authority form and
      ...
      <a href="mailto:bankfeedloads@myob.com">bankfeedloads@myob.com</a> and we
      will pass it on to your bank for approval.
      <div className={styles.bankFeedLoadEmail}>
        ...
        <Button type="secondary" onClick={() => copy(bankFeedLoadEmail)}>
          Copy
        </Button>
      </div>
      <hr />
