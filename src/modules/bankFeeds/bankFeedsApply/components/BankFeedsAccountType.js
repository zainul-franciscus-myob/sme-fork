...
const BankFeedsAccountType = ({
  ...
  renderRadios={({ id, value: currentVal, ...props }) => (
    <>
      <RadioButton {...props} checked={currentVal === 'Trading Account'} value="Trading Account" label="Bank account" />
      <RadioButton {...props} checked={currentVal === 'Credit card account'} value="Credit card account" label="Credit card account" />
    </>
  )}
/>;
