  ...
  applicationPreference ? (
    <>
      ...
      <div className={styles.securitySection}>
        ...
        <span>
          MYOB takes your security and privacy seriously. We protect all our data
          with <b><a href={PCIDSSLink} target="_blank" rel="noopener noreferrer">PCI DSS</a></b> global
          security and are compliant with ASIC and banking rules.
        </span>
      </div>
    </>
  ) : null
