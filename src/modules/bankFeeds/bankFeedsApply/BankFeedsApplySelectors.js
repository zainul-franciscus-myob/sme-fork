...
export const getBankAccounts = (state) =>
  state.financialInstitutions.bankAccounts;
...
export const getCreditCardAccounts = (state) =>
  state.financialInstitutions.creditCards;
export const getFinancialInstitution = (state) => state.financialInstitution;
export const getFinancialInstitutionCode = (state) =>
  state.financialInstitution.code;
...
export const getLastFourDigitsRequired = (state) =>
  state.lastFourDigitsRequired;
...
export const getIsBankAccount = (state) =>
  getAccountType(state) === 'Trading Account';
...
export const getTermsOfUseLink = createSelector(
  websiteLink,
  (basePath) =>
    `${basePath}/support/customer-service/myob-legal-notices/EssentialsTermsofUse`
);
...
export const getSubmitApplicationBody = (state) => {
  ...
  const getOptional = (getRequired, getValue) =>
    getRequired(state) ? getValue(state) : undefined;
