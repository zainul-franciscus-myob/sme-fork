...
export const getBankFeedsBankAccounts = state => state.financialInstitutions.bankAccounts;

export const getBankFeedsCreditCardAccounts = state => state.financialInstitutions.creditCards;
