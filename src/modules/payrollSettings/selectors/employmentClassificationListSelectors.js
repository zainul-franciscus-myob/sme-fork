...
export const getLoadingState = (state) =>
  state.employmentClassificationList.loadingState;
export const getIsLoading = (state) =>
  getLoadingState(state) === LoadingState.LOADING;

export const getIsTableLoading = (state) =>
  state.employmentClassificationList.isTableLoading;
...
const flipSortOrder = ({ employmentClassificationList: { sortOrder } }) =>
