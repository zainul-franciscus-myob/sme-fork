...
export const getTabUrl = (state, tab) =>
  `/#/${state.region}/${state.businessId}/payrollSettings?tab=${tab}`;
...
export const getCurrentYear = (state) =>
  state.generalPayrollInformation.currentYear;
export const getLoadingState = (state) =>
  state.generalPayrollInformation.loadingState;
...
export const getGeneralPayrollInformation = createStructuredSelector({
  ...
  withholdingPayerNumber: (state) =>
    state.generalPayrollInformation.withholdingPayerNumber,
  roundNetPay: (state) => state.generalPayrollInformation.roundNetPay,
  taxTableRevisionDate: (state) =>
    state.generalPayrollInformation.taxTableRevisionDate,
  defaultSuperFund: (state) => state.generalPayrollInformation.defaultSuperFund,
  defaultSuperFundOptions: (state) =>
    state.generalPayrollInformation.defaultSuperFundOptions,
  useTimesheets: (state) => state.generalPayrollInformation.useTimesheets,
  useTimesheetsWeekStarts: (state) =>
    state.generalPayrollInformation.useTimesheetsWeekStarts,
});
...
export const getUpdateGeneralPayrollInformationContent = createStructuredSelector(
  {
    ...
    withholdingPayerNumber: (state) =>
      state.generalPayrollInformation.withholdingPayerNumber,
    roundNetPay: (state) => state.generalPayrollInformation.roundNetPay,
    defaultSuperFund: (state) =>
      state.generalPayrollInformation.defaultSuperFund,
    useTimesheets: (state) => state.generalPayrollInformation.useTimesheets,
    useTimesheetsAction: (state) =>
      state.generalPayrollInformation.useTimesheetsAction,
    useTimesheetsWeekStarts: (state) =>
      state.generalPayrollInformation.useTimesheetsWeekStarts,
    isUseTimesheetsChanged: (state) =>
      state.generalPayrollInformation.isUseTimesheetsChanged,
  }
);
