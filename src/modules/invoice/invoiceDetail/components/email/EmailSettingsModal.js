import {
  Alert, Button, Input, Modal, Tooltip,
} from '@myob/myob-widgets';
import { connect } from 'react-redux';
import React from 'react';

import {
  getFromEmail, getFromName,
    ...
    >
      <Modal.Body>
        ...
        <div className={styles.description}>
          Before you can send invoices, you&apos;ll need to complete
          the settings below. You can update the email settings
          at any time in invoice and quote settings.
        </div>
        <Input
          name="fromName"
          label="From name"
      ...
      <Modal.Footer>
        ...
        <Button type="primary" onClick={onConfirm} disabled={isSubmitting}>Save</Button>
      </Modal.Footer>
    </Modal>
);
