...
import { getAmountDue, getIsCreating, getIsPageEdited } from './invoiceDetailSelectors';
import InvoiceStatus from '../types/InvoiceStatus';

const getIsClosedInvoice = state => state.invoice.status === InvoiceStatus.CLOSED;
...
export const shouldShowSaveAmountDueWarningModal = createSelector(
  ...
  (isEditingClosedInvoice,
    ...
    isEditingClosedInvoice || isCreatingNegativeAmountDue || isEditingOpenInvoiceToNegativeAmountDue
  ),
);
