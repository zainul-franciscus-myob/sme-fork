...
export const SORT_AND_FILTER_QUOTE_LIST = Symbol(
...
export const UPDATE_QUOTE_ID_AFTER_CREATE = Symbol(
  'Update quote id after create'
);
export const SET_DUPLICATE_ID = Symbol('Set duplicate id');
export const UPDATE_QUOTE_DETAIL_HEADER_OPTIONS = Symbol(
  'Update quote header options'
);
...
export const CALCULATE_QUOTE_ITEM_CHANGE = Symbol(
  'Calculate quote item change'
);
export const CALCULATE_QUOTE_AMOUNT_CHANGE = Symbol(
  'Calculate quote amount change'
);
export const CALCULATE_QUOTE_TAX_INCLUSIVE_CHANGE = Symbol(
  'Calculate quote tax inclusive change'
);
