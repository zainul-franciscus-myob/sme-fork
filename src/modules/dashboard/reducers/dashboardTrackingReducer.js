...
const loadTracking = (state, { tracking }) => setTrackingState(state, tracking);

const loadTrackingDetail = (
  state,
...
const setTrackingLoadingState = (state, { isLoading }) =>
  setTrackingState(state, { isLoading });

const setTrackingDetailLoadingState = (state, { isDetailLoading }) =>
  setTrackingState(state, { isDetailLoading });

const setTrackingErrorState = (state, { hasError }) =>
  setTrackingState(state, { hasError });

const setTrackingOptions = (state, { key, value }) =>
  setTrackingState(state, { [key]: value });
