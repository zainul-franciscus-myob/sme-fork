    ...
    <LearnTemplate title="Save time and paper with your In Tray">
      <Row>
        <Column>
          ...
          <ol>
            <li>
              Upload your bills and receipts from your computer,
              mobile app or forward them straight from your email
            </li>
            <li>
              Get our smart Optical Character Recognition (OCR)
              technology to pre-fill most of the data
            </li>
            <li>
