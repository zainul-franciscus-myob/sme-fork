...
import styles from './RecurringInvoiceOnlinePayment.module.css';

const RecurringInvoiceOnlinePayment = ({
  disabled,
  isLoading,
  isTrial,
  isServiceAvailable,
...
export default connect(mapStateToProps)(RecurringInvoiceOnlinePayment);
