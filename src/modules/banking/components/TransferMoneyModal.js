import {
  Alert, Button, Modal, ReadOnly, TextArea,
...
const TransferMoneyModal = ({
  ...
  const view = (
    <>
      {alertComponent}
      <ReadOnly name="Date" label="Date">{formattedDate}</ReadOnly>
      {
  ...
  return (
    ...
    >
      ...
      <Modal.Footer>
        ...
        <Button onClick={onConfirm} disabled={isModalBlocking}>Create</Button>
      </Modal.Footer>
    </Modal>
  );
};
