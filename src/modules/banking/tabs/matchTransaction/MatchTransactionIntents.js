export const SET_MATCH_TRANSACTION_INITIAL_STATE = Symbol(
  'Set match transaction initial state'
);
export const RESET_MATCH_TRANSACTION_STATE = Symbol(
  'Reset match transaction state'
);
