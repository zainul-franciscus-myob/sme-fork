...
describe('BillRedirectSelectors', () => {
  ...
  describe('getSupplierPaymentUrl', () => {
    [
      {
        name: '',
        value: '2',
      ...
      it(`should do things for ${test.name}`, () => {
        ...
        const expected = `/#/au/some-business/supplierPayment/new?supplierId=1&paymentAmount=${test.expected}&applyPaymentToPurchaseId=1`;

        const actual = getSupplierPaymentUrl(state);
