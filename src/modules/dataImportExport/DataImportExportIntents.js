...
export const UPDATE_EXPORT_DATA_TYPE = Symbol('Update export data type');
export const UPDATE_IMPORT_DATA_TYPE = Symbol('Update import data type');

export const ADD_IMPORT_FILE = Symbol('Add import file');
export const UPDATE_DUPLICATE_RECORDS_OPTION = Symbol(
  'Update duplicate records option'
);
export const UPDATE_DELETE_UNUSED_ACCOUNTS_VALUE = Symbol(
  'Update delete unused accounts checkbox'
);
...
export const IMPORT_TRANSACTION_JOURNALS = Symbol(
  'Import transaction journals'
);
export const IMPORT_TIMESHEETS = Symbol('Import timesheets');

export const BULK_DELETE_UNUSED_ACCOUNTS = Symbol(
  'Bulk delete unused accounts'
);

export const UPDATE_EXPORT_CHART_OF_ACCOUNTS_DETAIL = Symbol(
  'Update export chart of accounts detail'
);
export const EXPORT_CHART_OF_ACCOUNTS = Symbol('Export chart of accounts');

export const UPDATE_CONTACTS_IDENTIFY_BY = Symbol(
  'Update contacts identify by'
);
export const UPDATE_CONTACTS_TYPE = Symbol('Update contacts type');

export const UPDATE_EXPORT_COMPANY_FILE_DETAIL = Symbol(
  'Update export company file detail'
);
...
export const UPDATE_TAX_CODE_MAPPINGS = Symbol('Update Tax Code mappings');
