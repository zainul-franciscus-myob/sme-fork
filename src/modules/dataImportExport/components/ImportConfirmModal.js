...
const ImportConfirmModal = ({
  ...
  return (
    <Modal title="Import data?" size="small" onCancel={onCancelImportData}>
      <Modal.Body>{modalBody}</Modal.Body>
      <Modal.Footer>
        <Button type="secondary" onClick={onCancelImportData}>
          Go back
        </Button>
        <Button type="primary" onClick={onConfirmImportData}>
          Import
        </Button>
      </Modal.Footer>
    </Modal>
