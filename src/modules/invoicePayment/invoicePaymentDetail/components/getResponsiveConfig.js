export const getResponsiveConfig = (tableConfig) => [
  {
    ...
    config: [
      ...
      {
        columnName: tableConfig.invoiceNumber.columnName,
        styles: { width: 'flex-1' },
      },
      {
      ...
      {
        columnName: tableConfig.discountGiven.columnName,
        styles: { width: 'flex-1' },
      },
      {
        columnName: tableConfig.discountedBalance.columnName,
        styles: { width: 'flex-1' },
      },
      {
        columnName: tableConfig.amountReceived.columnName,
        styles: { width: 'flex-1' },
      },
    ],
  },
