...
export const GET_TASKS_LIST_FAILURE = Symbol('Get tasks list failure');
export const UPDATE_TASKS = Symbol('Update tasks');
export const UPDATE_TASKS_FAILURE = Symbol('Update tasks failure');
...
export const SET_HAS_CHECKED_BROWSER_ALERT = Symbol(
  'Set has checked browser alert'
);
