...
export const LOAD_INVOICE_DETAIL = Symbol('Load an existing invoice detail');
...
export const SET_SHOW_EMAIL_MODAL_AFTER_SAVE = Symbol('Set show email modal after save');
