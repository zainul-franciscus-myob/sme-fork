...
export const getFinancialYearStartDate = state => state.purchase.financialYearStartDate;
...
const getPurchaseTotalLabel = state => `Purchases for ${getPurchaseMonth(state)}`;
